...
describe('traverseExpr(c, s) function', () => {
  it('parses a number in the beginning', () => {
    ...
    expect(parsedExpr).to.deep.equal({tag: "literal", value: 987, type: {tag: "number"}});
  })
  ...
  it('parses addition', () => {
    ...
    // Note: we have to use deep equality when comparing objects
    expect(parsedExpr).to.deep.equal({"arg1": {"tag": "literal", "value": 2, type: {tag: "number"}}, "arg2": {"tag": "literal", "value": 3, type: {tag: "number"}}, "name": "+", "tag": "binop"});
  })
...
describe('parse(source) function', () => {
  it('parse a number', () => {
    ...
    expect(parsed).to.deep.equal([{tag: "expr", expr: {tag: "literal", value: 987, type: {tag: "number"}}}]);
  });  
...
describe('parse(source) function', () => {
  it('parse a Bool', () => {
    ...
    expect(parsed).to.deep.equal([{tag: "expr", expr: {tag: "literal", value: 1 + 2**32, type: {tag: "bool"}}}]);
  });  
...
describe('parse(source) function', () => {
  it('parse init', () => {
    ...
    expect(parsed).to.deep.equal([{tag: "init", name: "i", type: {tag: "bool"}, value: {tag: "literal", value: 1 + 2**32, type: {tag: "bool"}}, }]);
  });  
